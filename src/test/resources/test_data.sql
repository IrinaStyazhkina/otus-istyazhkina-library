INSERT INTO genres (`name`) VALUES ('novel'), ('fantasy'), ('poetry'), ('fairytale');
INSERT INTO authors (`name`, `surname`) VALUES ('Lev', 'Tolstoy'), ('Joseph', 'Brodskiy'), ('John', 'Tolkien'), ('Aleksandr', 'Kuprin');
